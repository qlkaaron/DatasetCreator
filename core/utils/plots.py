...
class Annotator:
    ...
    def box_label(self, box, label='', color=(128, 128, 128), txt_color=(255, 255, 255)):
        ...
        if self.pil or not is_ascii(label):
            ...
            msk1, msk2, msk3, msk4 = int(box[0]), int(box[1]), int(box[2]), int(box[3])
            ...
            if label:
                ...
                # 马赛克
                triangle = np.array([[msk1, msk2], [msk3, msk2], [msk3, msk4], [msk1, msk4]])
                cv2.fillConvexPoly(self.im, triangle, (34, 53, 87))
